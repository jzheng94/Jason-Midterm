...
class CNNApi {
    ...
    public static void main(String[] args) throws Exception {
        ...
        cnnAPIModel news = null;
        List<cnnAPIModel> list1 = new ArrayList<>();
        ...
        for (int i = 0; i < jsonArray.size()-1; i++) {
            try {
                ...
                news = new cnnAPIModel(source,author,title,description,url,urlToImage,publishedAt,content);
                list1.add(news);
        ...
        connectToSqlDB.insertDataFromStringToSqlTable(String.valueOf(list1),"CNN","News");
        try {
            List<String> newsDB = connectToSqlDB.readDataBase("CNN", "News");
        }catch(Exception e){
            System.out.println(e);
        }
        for(cnnAPIModel entry:list1){
